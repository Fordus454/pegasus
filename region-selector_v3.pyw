...
import os  
import psutil  # Required for managing processes  
...
regions = {  
    ...
    "SCAL": [  
        ...
        "N0499", "N0584", "N0706", "N0879", "N0916", "N3341", "N3361", "N3362", "N4421", 
    ],  
    "NE": [  
    ...
    "MW": [  
        ...
        "N0299", "N0676", "N0808", "N2221", "N2223", "N2242", "N2243", "N2261", "N2262", "N2263"  
    ],  
    "SE": [  
        ...
        "N7751", "N7752", "N7753", "N7754", "N7755", "N7761", "N7762" 
    ]  
} 
...
def close_victor_client():  
    #Close the Victor Client and its parent process.#  
    PARENT_PROCESS_NAME = "ACVS.Enterprise.Client.Core.Host.exe"  
  
    try:  
        # Find the parent process  
        parent_process = None  
        for process in psutil.process_iter(['name']):  
            if process.info['name'] == PARENT_PROCESS_NAME:  
                parent_process = process  
                break  
  
        if parent_process:  
            # Terminate all child processes of the parent  
            ...
            parent_process.wait()  # Wait for the parent process to terminate  
  
            print("Victor Client closed successfully.")  
        else:  
            print("Victor Client is not running.")  
    except psutil.NoSuchProcess:  
        print("Victor Client process does not exist.")  
    except psutil.AccessDenied:  
        print("Access denied while attempting to close Victor Client.")  
    except Exception as e:  
        print(f"Error closing Victor Client: {e}")  
...
def create_gui():  
    ...
    region_names = ["Northwest/Canada", "Southern California", "Southwest", "Northeast", "Midwest", "Southeast"]  
    ...
    root.bind("<Return>", lambda event: display_store_region())  
     ...
     # Close Victor Client button  
    close_button = tk.Button(  
        root,  
        text="Close Victor Client",  
        font=("Arial", 12, "bold"),  
        bg="#FF4500",  
        fg="white",  
        relief="solid",  
        ...
        padx=10,  
        pady=5,  
        command=close_victor_client  # Link the button to the function  
    )  
    close_button.pack(pady=(0,10), side="bottom", fill="x", padx=20) 
